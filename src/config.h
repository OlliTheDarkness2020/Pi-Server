...
#define PISERVER_REPO_URL PISERVER_DATADIR "/imageserver.json"
...
#define PISERVER_DOMAIN    "raspberry-server.local"
#define PISERVER_LDAP_DN   "dc=raspberry-server,dc=local"

#define PISERVER_LDAP_USER "cn=admin,dc=raspberry-server,dc=local"
